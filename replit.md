...
- **Nómina — Bonificación Incentivo Decreto 78-89 (BONO-01):** Q125/quincena for quincenal employees; Q250 on segunda quincena for mensual employees (Q0 on primera). No IGSS applied on this amount (it is a legal benefit additional to salary). Migration BONO-01 adds `bonificacion_incentivo` to `planilla_lineas` and `total_bonificacion_incentivo` to `planillas`.
