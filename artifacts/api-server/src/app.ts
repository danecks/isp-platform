...
app.post("/api/_system/reset-db", async (req, res) => {
  ...
  try {
    ...
    await pool.query("TRUNCATE TABLE puestos_operativos CASCADE");
    await pool.query("TRUNCATE TABLE client_sedes CASCADE");
    await pool.query("TRUNCATE TABLE client_aliases CASCADE");
    await pool.query("TRUNCATE TABLE clients CASCADE");
    await pool.query("TRUNCATE TABLE service_locations CASCADE");
    await pool.query("TRUNCATE TABLE operational_zones CASCADE");
    await pool.query("TRUNCATE TABLE position_aliases CASCADE");
    await pool.query("TRUNCATE TABLE turnos CASCADE");
    await pool.query("TRUNCATE TABLE users CASCADE");
    await pool.query("TRUNCATE TABLE config_tarifa_he CASCADE");
    await pool.query("TRUNCATE TABLE igss_config_patrono CASCADE");
    await pool.query("TRUNCATE TABLE wa_config CASCADE");
    await pool.query("TRUNCATE TABLE wa_menu_options CASCADE");
    await pool.query("TRUNCATE TABLE page_content CASCADE");
