...
armeriaRouter.get("/armeria/reportes/custodia-diaria", async (req, res) => {
  try {
...
armeriaRouter.get("/armeria/reportes/movimientos", async (req, res) => {
  try {
...
armeriaRouter.get("/armeria/reportes/municion", async (req, res) => {
  try {
    const hasta = parseFecha(req.query.hasta);
    const desde = parseFecha(req.query.desde, hasta);
    const clienteId = req.query.clienteId ? Number(req.query.clienteId) : null;
...
armeriaRouter.get("/armeria/reportes/sincronizaciones", async (req, res) => {
  try {
    const hasta = parseFecha(req.query.hasta);
    const desde = parseFecha(req.query.desde, hasta);
...
armeriaRouter.get("/armeria/reportes/inventario", async (req, res) => {
  try {
    const fecha = parseFecha(req.query.fecha);
    const clienteId = req.query.clienteId ? Number(req.query.clienteId) : null;
