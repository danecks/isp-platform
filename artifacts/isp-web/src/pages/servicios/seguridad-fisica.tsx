...
export default function SeguridadFisica() {
  const { c } = useCmsPage("seguridad-fisica");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeIn>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/20 text-primary font-medium text-sm mb-6 border border-primary/30">
              ...
              {c("hero_badge", "Servicio Especializado")}
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              {c("hero_title", "Seguridad Física")}
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              {c("hero_subtitle", "Presencia profesional y disuasiva en sus instalaciones. Agentes rigurosamente seleccionados, entrenados y supervisados para proteger su patrimonio y personal.")}
            </p>
          </FadeIn>
        </div>
      </section>
            ...
            <div>
              <FadeIn>
                <h2 className="text-3xl font-bold mb-8">
                  {c("section_title", "¿Qué incluye nuestro servicio?")}
                </h2>
            ...
            <div className="space-y-12">
              <FadeIn delay={0.2}>
                <h3 className="text-2xl font-bold mb-6">
                  {c("agents_title", "Perfil de nuestros agentes")}
                </h3>
                <p className="text-muted-foreground mb-6">
                  {c("agents_desc", "Todo el personal de ISP, S.A. atraviesa estrictos filtros de seguridad: pruebas psicométricas, estudio socioeconómico, carencia de antecedentes penales y policíacos, e inducción corporativa antes de pisar un puesto de servicio.")}
                </p>
        ...
        <div className="max-w-3xl mx-auto px-4">
          <FadeIn>
            <h2 className="text-3xl font-bold mb-6">
              {c("cta_title", "Asegure la continuidad de sus operaciones")}
            </h2>
