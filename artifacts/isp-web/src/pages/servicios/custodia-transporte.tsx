    ...
    <PageLayout>
      <section className="relative pt-32 pb-32 overflow-hidden">
        <div className="absolute inset-0 z-0">
          {/* armored truck transport logistics */}
          <img 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeIn>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/20 text-primary font-medium text-sm mb-6 border border-primary/30">
              <Truck className="w-4 h-4" /> Logística Segura
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Custodia de Transporte</h1>
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              Acompañamiento táctico para la protección de mercadería en tránsito. Minimizamos el riesgo de asalto, desvío o pérdida en las carreteras de Guatemala.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
            {[
              { icon: ShieldAlert, title: "Escolta Armada", desc: "Agentes altamente capacitados en vehículos escolta para proteger transportes de alto valor y neutralizar amenazas." },
              { icon: Map, title: "Evaluación de Rutas", desc: "Análisis previo de trayectos, identificación de zonas rojas y planificación de rutas alternas seguras." },
              { icon: CheckCircle, title: "Control en Origen y Destino", desc: "Verificación de marchamos y precintos desde el punto de carga hasta la entrega final de la mercadería." }
            ].map((item, i) => (
          ...
          <div className="bg-card p-10 lg:p-16 rounded-3xl border border-white/5">
            <div className="max-w-3xl mx-auto text-center">
              <FadeIn>
                <h2 className="text-3xl font-bold mb-6">Proceso Operativo</h2>
                <p className="text-lg text-muted-foreground mb-12">
                  Implementamos un protocolo estricto que no deja espacio a la improvisación.
                </p>
              </FadeIn>
      ...
      <section className="py-20 bg-background border-t border-white/5 text-center">
        <div className="max-w-3xl mx-auto px-4">
          <FadeIn>
            <h2 className="text-3xl font-bold mb-6">Proteja su cadena de suministro hoy</h2>
