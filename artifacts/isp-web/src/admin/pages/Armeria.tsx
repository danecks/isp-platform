...
interface Puesto { id: number; nombre: string; cliente_nombre: string; agente_id: number | null; agente_nombre: string | null; zona_nombre: string | null; }
...
function ModalArma({
  ...
  async function save() {
    if (!form.codigo.trim()) { toast({ title: "Código requerido", variant: "destructive" }); return; }
    setSaving(true);
    try {
      const body = {
        ...form,
