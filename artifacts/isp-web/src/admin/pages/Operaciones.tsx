    ...
    <AdminLayout title="Pizarrón Operativo">
      <DndContext sensors={sensors} onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
        <div className="flex flex-col h-full gap-4" style={{ minHeight: 0 }}>
          ...
          {/* ── Cuerpo principal: tablero (izquierda) + sidebar (derecha) ── */}
          ...
          {adminTablero && adminTablero.empleados.length > 0 && (() => {
            ...
            return (
              <div className="shrink-0 bg-[#060f1a] border border-slate-500/15 rounded-2xl overflow-hidden">
                {/* Header */}
                <button
          ...
          </div>{/* ── fin sidebar derecho ── */}
          </div>{/* ── fin cuerpo horizontal ── */}
