...
import {
  ...
  type AgenteRankeado,
  type SupervisorPool,
  type JefeServicioPool,
  type AdministrativoPool,
  type Pool,
  type PlanFuturo,
  type AgentePoolFuturo,
  type PlanAgenteSSA,
  type SsaAgente,
  type InicioProyecto,
  type PoolFuturoData,
  ...
  type CierreResumen,
  type AgenteDeclino,
  type TarjetaSSAPendiente,
  type CierreDiaRecord,
  type DiaPendienteCierre,
  type CierreHoyData,
  type Segmento,
...
import {
    ...
    TURNO_COLORS,
    TIPO_MOV,
    etiquetaInicioFuturo,
    parseHM,
    fmt2,
    minToHM,
  } from "./operaciones/utils";
