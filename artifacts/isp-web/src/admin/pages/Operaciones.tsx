                ...
                {ssaSinAgente.map((t) => {
                  ...
                  return (
                    <a
                      key={t.id}
                      href="/admin/tablero-servicios"
                      className={`shrink-0 flex flex-col gap-1 border rounded-xl px-3 py-2 min-w-[210px] max-w-[240px] cursor-pointer hover:brightness-110 transition-all ${prioColor}`}
                    >
                      <div className="flex items-center justify-between gap-2">
