...
import AdminSimuladorEscenarios from "@/admin/pages/whatsapp-simulator/EscenariosAdmin";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/admin/simulador-whatsapp/escenarios">
        {() => <AuthGuard requiredRoles={["admin"]}><AdminSimuladorEscenarios /></AuthGuard>}
      </Route>
