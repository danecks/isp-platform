  ...
  const Reverso = () => (
    <div style={{ width: W, height: H, display: "flex", flexDirection: "column", overflow: "hidden", fontFamily: "Arial, sans-serif", background: "#fff", borderRadius: 6, boxShadow: "0 8px 32px rgba(0,0,0,0.35)", flexShrink: 0 }}>
      ...
      <img
        ...
        alt="ISP"
        style={{ display: "block", width: "auto", height: "auto", maxWidth: "88%", maxHeight: 140, margin: "8px auto 4px", mixBlendMode: "multiply" as const, transform: "scale(1.7)", transformOrigin: "center" }}
      />
