    ...
    <div style={{ width: W, height: H, display: "flex", flexDirection: "row", overflow: "hidden", fontFamily: "Arial, sans-serif", background: "#fff", borderRadius: 6, boxShadow: "0 8px 32px rgba(0,0,0,0.35)", flexShrink: 0 }}>
      ...
      <div style={{ width: SW, height: H, background: "linear-gradient(180deg,#0a1a3d 0%,#0f2044 60%,#0a1a3d 100%)", display: "flex", flexDirection: "column", alignItems: "center", flexShrink: 0, position: "relative", boxSizing: "border-box" }}>
        ...
        <div style={{ width: 30, height: 30, borderRadius: "50%", background: "#fff", marginTop: 12, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 2px 6px rgba(0,0,0,0.4)", flexShrink: 0, overflow: "hidden" }}>
          <img src="https://987b05e8-e17a-40f4-b366-3baeddd84475-00-2jyjpes488ag2.riker.replit.dev/images/logo-isp.png" alt="ISP" style={{ width: 22, height: 22, objectFit: "contain", mixBlendMode: "multiply" as const, transform: "scale(1.9)", transformOrigin: "center" }} />
        </div>
